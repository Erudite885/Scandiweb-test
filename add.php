...
<script type="text/javascript">
    function run(){
        ...
        if (campo == '3'){
            $("#endForm").html("<br><br><label>Height(CM)</label><br><input type=\"number\" name=\"height\" placeholder=\"Insert height(CM)\" id=\"height\" oninvalid=\"this.setCustomValidity('Enter Product Height(CM) Here')\" oninput=\"this.setCustomValidity('')\" required /><br><br><label>Width(CM)</label><br><input type=\"number\" name=\"width\" placeholder=\"Insert width(CM)\" id=\"width\" oninvalid=\"this.setCustomValidity('Enter Product Width (CM) Here')\" oninput=\"this.setCustomValidity('')\" required /><br><br><label>Length(CM)</label><br><input type=\"number\" name=\"length\" placeholder=\"Insert length(CM)\" id=\"length\" oninvalid=\"this.setCustomValidity('Enter Product Length(CM) Here')\" oninput=\"this.setCustonValidity('')\" required /><br>");
        }
    }
</script>
